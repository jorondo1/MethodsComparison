...
#SBATCH -D /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/NAFLD/MPA_db2023
...
export __sample_line=$(cat /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/NAFLD/preproc/preprocessed_reads.sample.tsv | awk "NR==$SLURM_ARRAY_TASK_ID")
...
-o /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/NAFLD/MPA_db2023/ \
-tmp $SLURM_TMPDIR \
-t 24 \
-s $__sample \
-fq1 $__fastq_file1 \
