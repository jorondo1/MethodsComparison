...
#SBATCH -D /net/nfs-ip34/fast2/def-ilafores/Bee/preproc
#SBATCH -o /net/nfs-ip34/fast2/def-ilafores/Bee/preproc/logs/preprocess.kneaddata-%A_%a.slurm.out
...
-o /net/nfs-ip34/fast2/def-ilafores/Bee/preproc \
-tmp $SLURM_TMPDIR \
-t 24 -m 30G \
