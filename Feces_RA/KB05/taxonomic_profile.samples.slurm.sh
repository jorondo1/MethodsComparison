...
#SBATCH -D /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/Feces_RA/KB05
...
-o /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/Feces_RA/KB05 \
-tmp $SLURM_TMPDIR \
-t 48 -m 250G \
-s $__sample \
-fq1 $__fastq_file1 \
