...
sbatch --array=1-"$NUM_PD" $MC/PD/MPA_db2022/mfetaphlan.slurm.sh
...
sbatch --mem=120G --array=1-"$NUM_AD_Skin" $MC/scripts/gather_SLURM_fast.sh "AD_Skin" $AD_Skin_TSV "genbank-2022.03"
sbatch --mem=31G --array=1-"$NUM_AD_Skin" $MC/scripts/gather_SLURM_fast.sh "AD_Skin" $AD_Skin_TSV "gtdb-rs214-rep"
sbatch --mem=80G --array=1-"$NUM_AD_Skin" $MC/scripts/gather_SLURM_fast.sh "AD_Skin" $AD_Skin_TSV "gtdb-rs214-full"

sbatch --mem=120G --array=1-"$NUM_PD" $MC/scripts/gather_SLURM_fast.sh "PD" $PD_TSV "genbank-2022.03"
sbatch --mem=31G --array=1-"$NUM_PD" $MC/scripts/gather_SLURM_fast.sh "PD" $PD_TSV "gtdb-rs214-rep"
sbatch --mem=80G --array=1-"$NUM_PD" $MC/scripts/gather_SLURM_fast.sh "PD" $PD_TSV "gtdb-rs214-full"

# Check completion status
check_output 'gtdb-rs214-rep gtdb-rs214-full genbank-2022.03' 'AD_Skin PD' _gather.csv
