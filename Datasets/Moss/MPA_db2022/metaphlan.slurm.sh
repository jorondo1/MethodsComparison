...
#SBATCH -D /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/Moss/MPA_db2022
...
-o /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/Moss/MPA_db2022/ \
-tmp $SLURM_TMPDIR \
-t 24 \
-s $__sample \
-fq1 $__fastq_file1 \
