...
#SBATCH -D /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/PD/preproc
#SBATCH -o /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/PD/preproc/logs/preprocess.kneaddata-%A_%a.slurm.out
...
export __sample_line=$(cat /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/PD/raw/samples_to_process.tsv | awk "NR==$SLURM_ARRAY_TASK_ID")
...
-o /nfs3_ib/nfs-ip34/home/def-ilafores/analysis/MethodsComparison/PD/preproc \
-tmp $SLURM_TMPDIR \
-t 24 -m 120G \
