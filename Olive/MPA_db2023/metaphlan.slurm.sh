...
#SBATCH -D /net/nfs-ip34//home/def-ilafores/analysis/MethodsComparison/Olive/MPA_db2023
...
-o /net/nfs-ip34//home/def-ilafores/analysis/MethodsComparison/Olive/MPA_db2023/ \
-tmp $SLURM_TMPDIR \
-t 24 \
-s $__sample \
-fq1 $__fastq_file1 \
...
-db /net/nfs-ip34/fast/def-ilafores/metaphlan4_db/mpa_vJun23_CHOCOPhlAnSGB_202307
